...
let s:toml_file = s:dein_config_dir . '/toml/dein.toml'               " Base toml file
let s:toml_local_file = s:dein_config_dir . '/toml/dein_local.toml'   " Local toml file
...
if dein#load_state(s:dein_dir)
  ...
  call dein#load_toml(s:toml_local_file, {'lazy': 0})
  call dein#end()
